...
import { DatabaseMongoFullAuditedEntityAbstract } from '../../common/database/abstracts/mongo/entities/database.mongo.full-audited-entity.abstract';
...
export class InvestorEntity extends DatabaseMongoFullAuditedEntityAbstract {
  ...
  @AutoMap()
  @Prop({
    type: [{ ref: RoleEntity.name, type: ObjectId, default: null }],
  })
  roles: RoleEntity[];
